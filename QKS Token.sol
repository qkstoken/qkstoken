...
contract QKSToken is Context, IBEP20, Ownable, Pausable {
    ...
    address private charityAdd = 0xE5C3f16460f5eBc24266576bb760F8d8b9D366B7;
    uint256 private _numTokensSellToAddToLiquidity = 1.5 * 10**12 * 10**9;    
    uint256 public maximumTXamount = _tTotal.div(10**3);
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "QKS Token";
    string private _symbol = "QKS";
    ...
    function setFee(uint256 taxFee, uint256 liqFee) public onlyOwner {
        _taxFee = taxFee;
